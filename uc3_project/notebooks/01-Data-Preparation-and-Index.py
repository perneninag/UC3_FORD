...
# MAGIC %pip install --quiet -U pydantic==2.9.2 databricks-sdk==0.40.0 databricks-langchain databricks-agents mlflow[databricks] langchain==0.3.19 langchain_core==0.3.37 databricks-vectorsearch==0.49 
